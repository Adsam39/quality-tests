...
class BankUnitTests {
    ...
    @Test
    fun `transfert money using bank`(){

        //Given
        val bank = Bank()
        val account1 = Account("FR7630001007941234567890185", 50.0)
        val account2 = Account("FR7630001007941234567890174", 60.0)
        bank.register(account1)
        bank.register(account2)

        //When
        bank.transfer(account1, account2, 25.0)

        //Then
        Assertions.assertEquals(25.0, account1.balance)
        Assertions.assertEquals(25.0, account2.balance)
    }
}
